...
function PostModal({ isOpen, onClose, onConfirm }) {
        ...
        <div className="modal-overlay">
            <div className="modal-content" ref={modalRef}>
                <div className="modal-header">
                    ...
                    <svg width="24px" height="24px" className="close-icon" onClick={onClose} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
